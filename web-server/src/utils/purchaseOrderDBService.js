        ...
        var P = new Promise(async(res, rej) => {
            try {
                var sequenceDocument = await dbo
                    .collection("counters")
                    .findAndModify({ _id: "purchaseOrderId" }, [
                        ["_id", "asc"]
...
async function retrieveDistinctNames() {

    var retrieveAllDistinctNames = new Promise((res, rej) => {
    ...
    var p = await retrieveAllDistinctNames
...
module.exports = {
    ...
    retrieveDistinctNames: retrieveDistinctNames
}